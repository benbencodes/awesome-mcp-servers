...
- 💰 [llm-prices](https://github.com/benbencodes/llm-prices) - Look up and compare LLM API costs across 273 models and 44 providers (OpenAI, Anthropic, Google, Mistral, DeepSeek, xAI, and more). Zero-dependency Python MCP server, no API key required.
