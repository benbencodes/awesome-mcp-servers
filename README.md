...
- 💰 [llm-prices](https://github.com/benbencodes/llm-prices) - Zero-dependency CLI + MCP server for comparing LLM API pricing across 232 models and 35 providers (OpenAI, Anthropic, Google, Groq, xAI, DeepSeek, Qwen, etc.). Calculate costs, find cheapest models, compare providers. No API key required.
