...
- <img src="https://cdn.simpleicons.org/python/3776AB" height="14"/> [llm-prices](https://github.com/benbencodes/llm-prices) - MCP server and CLI for comparing LLM API pricing across 152 models and 22 providers (OpenAI, Anthropic, Google, Mistral, xAI, DeepSeek, Groq, and more). No API key required — pricing data is built in.
